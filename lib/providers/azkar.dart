...
class Azkar with ChangeNotifier {
  static const _azkar = [
    ...
    'أَسْتَغْفِرُ اَللَّهُ اَلْعَظِيمُ اَلَّذِي لَا إِلَهَ إِلَّا هُوَ اَلْحَيَّ اَلْقَيُّومْ وَأَتُوبُ إِلَيْهِ',
    ...
    'سُبْحَانَ اَللَّهِ وَبِحَمْدٍهِ ، سُبْحَانَ اَللَّهِ اَلْعَظِيمِ',
  ...
  String _normalizeArabic(String text) {
    return text.replaceAll(RegExp('[\u064B-\u065F\u0670]'), ''); // Remove diacritics and tatweel
  }

  List searchResults(String query) {
    final normalizedQuery = _normalizeArabic(query);
    List search_results = _azkar.where((element) {
